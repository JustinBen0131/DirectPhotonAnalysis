...
class ClusterIso : public SubsysReco
{
 public:
   ...
   */
  ClusterIso(const std::string&, float eTCut, int coneSize, bool do_subtracted, bool do_unsubtracted, bool limitEvents);
 ...
 private:
  ...
  bool m_limitEvents;     ///< Boolean to control event limiting
  int m_eventLimit = 10000;  ///< Maximum number of events (default 10,000)
};
